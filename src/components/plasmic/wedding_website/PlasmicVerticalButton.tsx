...
import sty from "./PlasmicVerticalButton.module.css"; // plasmic-import: n9pSBCdmzjFm/css
...
export type PlasmicVerticalButton__VariantMembers = {
...
export type PlasmicVerticalButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicVerticalButton__VariantsArgs;
export const PlasmicVerticalButton__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicVerticalButton__ArgsType = {
...
type ArgPropType = keyof PlasmicVerticalButton__ArgsType;
export const PlasmicVerticalButton__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
export type PlasmicVerticalButton__OverridesType = {
  root?: p.Flex<"button">;
...
export interface DefaultVerticalButtonProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal" | "unnamedVariant">;
...
function PlasmicVerticalButton__RenderFunc(props: {
  variants: PlasmicVerticalButton__VariantsArgs;
  args: PlasmicVerticalButton__ArgsType;
  overrides: PlasmicVerticalButton__OverridesType;
  forNode?: string;
}) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__uJ9Gx)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg___1ZdlU)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicVerticalButton>(
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicVerticalButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicVerticalButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicVerticalButton__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicVerticalButton__ArgProps,
          internalVariantPropNames: PlasmicVerticalButton__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicVerticalButton__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicVerticalButton";
  } else {
    func.displayName = `PlasmicVerticalButton.${nodeName}`;
  }
  return func;
}

export const PlasmicVerticalButton = Object.assign(
  // Top-level PlasmicVerticalButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicVerticalButton
    internalVariantProps: PlasmicVerticalButton__VariantProps,
    internalArgProps: PlasmicVerticalButton__ArgProps,

    useBehavior
  }
);

export default PlasmicVerticalButton;
/* prettier-ignore-end */
