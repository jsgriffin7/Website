...
import sty from "./PlasmicHorizontalButton.module.css"; // plasmic-import: j65rprFYbCCL/css
...
export type PlasmicHorizontalButton__VariantMembers = {
...
export type PlasmicHorizontalButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicHorizontalButton__VariantsArgs;
export const PlasmicHorizontalButton__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicHorizontalButton__ArgsType = {
...
type ArgPropType = keyof PlasmicHorizontalButton__ArgsType;
export const PlasmicHorizontalButton__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
export type PlasmicHorizontalButton__OverridesType = {
  root?: p.Flex<"button">;
...
export interface DefaultHorizontalButtonProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal" | "unnamedVariant">;
...
function PlasmicHorizontalButton__RenderFunc(props: {
  variants: PlasmicHorizontalButton__VariantsArgs;
  args: PlasmicHorizontalButton__ArgsType;
  overrides: PlasmicHorizontalButton__OverridesType;
  forNode?: string;
}) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__gcBPp)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__fvOb)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicHorizontalButton>(
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicHorizontalButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicHorizontalButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicHorizontalButton__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicHorizontalButton__ArgProps,
          internalVariantPropNames: PlasmicHorizontalButton__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicHorizontalButton__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicHorizontalButton";
  } else {
    func.displayName = `PlasmicHorizontalButton.${nodeName}`;
  }
  return func;
}

export const PlasmicHorizontalButton = Object.assign(
  // Top-level PlasmicHorizontalButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicHorizontalButton
    internalVariantProps: PlasmicHorizontalButton__VariantProps,
    internalArgProps: PlasmicHorizontalButton__ArgProps,

    useBehavior
  }
);

export default PlasmicHorizontalButton;
/* prettier-ignore-end */
